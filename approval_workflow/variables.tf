variable "approval_workflow_steps" {
  description = "(Optional) (Updatable) ApprovalWorkflowSteps applicable for the ApprovalWorkflowInstance."
  type = list(object({
...
variable "description" {
  description = "(Optional) (Updatable) Description of the ApprovalWorkflow."
  type        = string
  default     = null
}
...
variable "max_duration" {
  description = "(Required) (Updatable) Max duration of the ApprovalWorkflow must be acted at all levels."
  type = object({
    unit  = string
    value = number
  })
...
variable "name" {
  description = "(Required) (Updatable) Name of the ApprovalWorkflow."
  type        = string
}
