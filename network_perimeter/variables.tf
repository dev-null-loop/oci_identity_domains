...
variable "description" {
  description = "(Optional) (Updatable) NetworkPerimeter Description"
  type        = string
  default     = null
}
...
variable "ip_addresses" {
  description = "(Required) (Updatable) IPAddresses or Ranges assigned to the NetworkPerimeter"
  type = list(object({
...
variable "name" {
  description = "(Required) (Updatable) NetworkPerimeter name"
  type        = string
}
