variable "approvers" {
  description = "(Optional) Approvers of the ApprovalWorkflowStep."
  type = list(object({
...
variable "approvers_expressions" {
  description = "(Optional) approversExpressions of ApprovalWorkflowStep"
  type        = list(string)
  default     = []
}
...
variable "minimum_approvals" {
  description = "(Optional) Minimum number of Approvals required for this step."
  type        = number
  default     = null
}
...
variable "order" {
  description = "(Required) Order of the ApprovalWorkflowStep."
  type        = number
}
...
variable "type" {
  description = "(Required) Type of ApprovalWorkflowStep"
  type        = string
}
