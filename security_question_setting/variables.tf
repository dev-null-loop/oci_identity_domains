...
variable "max_field_length" {
  description = "(Required) (Updatable) Indicates the maximum length of following fields Security Questions, Answer and Hint"
  type        = number
}

variable "min_answer_length" {
  description = "(Required) (Updatable) Indicates the minimum length of answer for security questions"
  type        = number
}

variable "num_questions_to_ans" {
  description = "(Required) (Updatable) Indicates the number of security questions that a user must answer"
  type        = number
}

variable "num_questions_to_setup" {
  description = "(Required) (Updatable) Indicates the number of security questions a user must setup"
  type        = number
}
