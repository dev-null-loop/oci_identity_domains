...
variable "db_password" {
  description = "(Required) The user's database password."
  type        = string
  sensitive   = true
}
...
variable "expires_on" {
  description = "(Optional) When the user credential expires."
  type        = string
  default     = null
}
...
variable "status" {
  description = "(Optional) User credential status"
  type        = string
  default     = null
}
...
variable "user" {
  description = "(Optional) The user linked to the database credential."
  type = object({
