variable "identity_proofing_provider_template_provider" {
...
variable "configuration" {
  description = "(Optional) (Updatable) Proofing Provider Configuration Template."
  type = list(object({
    name        = string
    sensitivity = bool
    type        = string
...
variable "service_type" {
  description = "(Required) (Updatable) Service type supported by the Identity Proofing Provider."
  type        = set(string)
}

variable "verification_url" {
  description = "(Required) (Updatable) verification URL."
  type        = string
}
