variable "active" {
  description = "(Optional) (Updatable) Activation status for this Cloud Gate"
  type        = bool
  default     = null
}
...
variable "display_name" {
  description = "(Required) (Updatable) Display name/Host identifier for this Cloud Gate"
  type        = string
}
...
variable "last_modified_time" {
  description = "(Optional) (Updatable) Last updated timestamp for this CloudGate's servers and mappings."
  type        = string
  default     = null
}
...
variable "type" {
  description = "(Optional) Type of Cloud Gate"
  type        = string
  default     = null
}
