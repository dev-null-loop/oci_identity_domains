variable "active" {
  description = "(Optional) (Updatable) If true, Policy is active."
  type        = bool
  default     = null
}
...
variable "description" {
  description = "(Optional) (Updatable) Policy Description"
  type        = string
  default     = null
}
...
variable "name" {
  description = "(Required) (Updatable) Policy name"
  type        = string
}
...
variable "policy_groovy" {
  description = "(Optional) (Updatable) The Groovy script that is run instead of the policy, if the policy type allows the policy to be a Groovy script."
  type        = string
  default     = null
}
...
variable "rules" {
  description = "(Optional) (Updatable) Rules assigned to this policy"
  type = list(object({
    sequence = number
    value    = string
  }))
