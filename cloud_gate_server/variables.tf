...
variable "display_name" {
  description = "(Required) (Updatable) Display name for the Server block"
  type        = string
}

variable "host_name" {
  description = "(Required) (Updatable) Hostname for the Server block"
  type        = string
}
...
variable "nginx_settings" {
  description = "(Optional) (Updatable) More nginx Settings. JSON encoded text block"
  type        = string
  default     = null
}
...
variable "port" {
  description = "(Required) (Updatable) Port for the Server Block"
  type        = number
}
...
variable "ssl" {
  description = "(Required) (Updatable) SSL flag for the Server Block"
  type        = bool
}
