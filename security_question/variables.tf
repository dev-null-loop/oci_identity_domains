variable "active" {
  description = "(Required) This indicates if the question is selected by the Security Admin and is available for the end user."
  type        = bool
}
...
variable "question_text" {
  description = "(Required) Locale values for the Question"
  type = list(object({
...
variable "type" {
  description = "(Required) This indicates if the question is a Custom Question added by the Security Admin."
  type        = string
}
